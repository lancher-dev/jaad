...
Pages outside the documentation use their own Astro layouts, or
`@lancher-dev/jaad/layouts/Page.astro` to keep the same header and footer.
Advanced projects can rearrange the documentation UI with the optional
